...
/** The port the server is hosting its game server on. *//** The host the server is binding to. */
/** The host the server binds to. */
export const host: string = "caoqq6.github.io";
export const serverPort: number = process.env.GHPAGES ? 0 : 8000;
export const clientLocation: string = process.env.GHPAGES ? "./docs" : "./client";
